...
class ViewModel: ObservableObject {
    @Published var selectedPrompt: String = "" {
        didSet {
            systemPromptInput = selectedPrompt
            api.updateSystemPrompt(selectedPrompt: selectedPrompt)
        }
    }

    @Published var systemPromptInput: String = ""
    @Published var systemPrompts: [String] = ["Prompt 1", "Prompt 2", "Prompt 3"]
