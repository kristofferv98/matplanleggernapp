...
class ChatGPTAPI {
    ...
    init(apiKey: String, model: String = "gpt-3.5-turbo", temperature: Double = 0.2, selectedPrompt: String = "Lag en detaljert oppskrift basert på brukerens ønske. Du kan selv velge oppskriften. Den skal være lett og billig. Svaret må inneholde navn, introduksjon, forberedelsestid, Koketid, serveringsmengde, ingridienser, fremgangsmåte, avslutting.") {
        self.apiKey = apiKey
        self.model = model
    ...
    // Change systemMessage to be a variable
